...
@section('page-title', 'Edit Collection: ' . $collection->name)
    ...
    <form action="{{ route('admin.collections.update', $collection) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-6 space-y-6">
            ...
            <div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $collection->description) }}</textarea>
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mb-4">Select products to include in this collection ({{ count($selectedProducts) }} selected)</p>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3"
                                  class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('meta_description', $collection->meta_description) }}</textarea>
                    </div>
            ...
            <div>
                ...
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" {{ $collection->is_active ? 'checked' : '' }}
                           class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
