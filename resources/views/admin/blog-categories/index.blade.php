...
@section('header-actions')
    <a href="{{ route('admin.blog-categories.create') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">
        <i class="fas fa-plus mr-2"></i>Add Blog Category
    </a>
@endsection
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($categories as $category)
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <form action="{{ route('admin.blog-categories.toggle-status', $category) }}" method="POST" class="inline">
                                @csrf
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <a href="{{ route('admin.blog-categories.create') }}" class="text-indigo-600 hover:text-indigo-800 mt-2 inline-block">
