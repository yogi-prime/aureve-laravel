    ...
    <form action="{{ route('admin.blog-categories.update', $blog_category) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $blog_category->name) }}"
            ...
            <div class="flex items-center pt-6">
                <input type="checkbox" name="is_active" id="is_active" value="1"
                       ...
                       {{ old('is_active', $blog_category->is_active) ? 'checked' : '' }}>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 @error('description') border-red-500 @enderror">{{ old('description', $blog_category->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2 border-t pt-6 mt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title', $blog_category->seo_title) }}"
                    ...
                    <div>
                        ...
                        <textarea name="seo_description" id="seo_description" rows="2"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">{{ old('seo_description', $blog_category->seo_description) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
